<x-layout>
    ...
    <div class="flex justify-between items-center w-full mb-8">
        ...
        <a
            ...
            class="inline-block py-2 px-6 rounded-l-xl rounded-t-xl bg-primary hover:bg-white cursor-pointer hover:border-[#faca15] hover:text-primary focus:text-primary focus:bg-gray-200 text-gray-50 font-bold leading-loose transition duration-200"
        >
            Tambah
        </a>
    </div>
