<x-layout>
    ...
    <div class="flex justify-end p-5">
        <a
            ...
            class="inline-block py-2 px-6 rounded-l-xl rounded-t-xl bg-primary hover:bg-white cursor-pointer hover:border-primary hover:text-primary focus:text-primary focus:bg-gray-200 text-gray-50 font-bold leading-loose transition duration-200"
        >
            Cek Surat
        </a>
    </div>
    <div class="grid gap-6 lg:grid-cols-4 sm:grid-cols-2">
        @foreach ($data as $item)
            ...
            >
                ...
                <a
                    href="{{ $item["href"] }}"
                    class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-primary rounded-lg hover:bg-hover focus:ring-4 focus:outline-none focus:ring-blue-300 "
                >
                    Ajukan Surat
                    <svg
